...
class PublicationsController extends Controller
{
    ...
    public function view($slug)
    {
        ...
        $publications = Publication::available()->sections($section->id);

        SEOMeta::setTitle('Medical Innovation & Technology - ' . $section->label);
        ...
        SEOTools::setTitle('Medical Innovation & Technology - ' . $section->label);
        ...
        OpenGraph::setTitle('Medical Innovation & Technology - ' . $section->label);
        ...
        JsonLd::setTitle('Medical Innovation & Technology - ' . $section->label);
        ...
        return view('pages.views.publications.view')->with([
