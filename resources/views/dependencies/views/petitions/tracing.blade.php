                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center">
                                <div class="d-flex mr-auto mb-sm-0 mb-2 align-items-center">
                                    ...
                                    <div>
                                        <h5 class="fs-18 text-black font-w600">{{ $petition->token }}</h5>
                                        <div class="dropdown">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card  message-bx chat-box">
                            ...
                            <div id="listMassages">
                                @include ('dependencies.partials.sections.tracings')
                            </div>

                            <form  id="formMassage" enctype="multipart/form-data"  role="form" onSubmit="return false">

                                <input name="petition" type="hidden" value="{{ $petition->token }}">


                                <div class="card-footer border-0 type-massage">

                                    <div class="input-group">
                                        <textarea class="form-control" name="observation" id="observation" placeholder="Type message..."></textarea>
...
@push('scripts')
    ...
    <script>
            ...
            $(".addMassage").click(function() {
                ...
                $.ajax({
                        url: "/dependencie/petitions/tracing/store",
                        headers: {
