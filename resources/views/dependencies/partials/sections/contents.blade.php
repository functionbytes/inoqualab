<div class="tab-content project-list-group" id="myTabContent">
        ...
        @foreach($alls as $all)
                <div class="card">
                    <div class="project-info">
                        <div class="col-xl-5  my-2 col-lg-5 col-md-5 col-sm-6 col-6">
                            ...
                            <div class="d-flex project-status align-items-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="{{ route('dependencie.petitions.report', $all->token) }}" >Reporte</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex project-status align-items-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="{{ route('dependencie.petitions.report', $pending->token) }}" >Reporte</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="tab-pane fade" id="navpills-3">
        @foreach($process as $proces)
            <div class="card">
                <div class="project-info">
                    <div class="col-xl-5  my-2 col-lg-4 col-md-5 col-sm-6 col-6">
                    ...
                    <div class="col-xl-2  my-2 col-lg-2 col-md-2 col-sm-6 col-6">
                        <div class="d-flex project-status align-items-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('dependencie.petitions.view', $proces->token) }}" >Visualizar</a>
                                    <a class="dropdown-item" href="{{ route('dependencie.petitions.edit', $proces->token) }}" >Editar</a>
                                    <a class="dropdown-item" href="{{ route('dependencie.petitions.report', $proces->token) }}" >Reporte</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex project-status align-items-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="{{ route('dependencie.petitions.report', $finished->token) }}" >Reporte</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="tab-pane fade" id="navpills-5">
        @foreach($solutions as $solution)
                <div class="card">
                    <div class="project-info">
                        <div class="col-xl-5  my-2 col-lg-5 col-md-5 col-sm-5 col-6">
                        ...
                        <div class="col-xl-5  my-2 col-lg-5 col-md-5 col-sm-4 col-6">
                            <div class="d-flex align-items-center">
                                <div class="user-avatar-sm customer">
                        ...
                        <div class="col-xl-2  my-2 col-lg-2 col-md-2 col-sm-3 col-6">
                            <div class="d-flex project-status align-items-center">
                                <div class="dropdown">
                                    <a href="javascript:void(0);" data-toggle="dropdown" aria-expanded="false">
                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="{{ route('dependencie.petitions.report', $solution->token) }}" >Reporte</a>
                                    </div>
                                </div>
                            </div>
                        </div>
