      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="{{ route('manager.products') }}">Listado</a>
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="{{ route('manager.sales') }}">Listado</a>
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="{{ route('manager.inventaries') }}">Inventario</a>
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="{{ route('manager.quotations') }}">Listado</a>
                <span class="icon-thumbnail">fl</span>
              </li>
              <li class="">
                <a href="{{ route('manager.quotations') }}">Crear</a>
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="{{ route('manager.events') }}">Listado</a>
                <span class="icon-thumbnail">fl</span>
              </li>
              <li class="">
                <a href="{{ route('manager.sales.create') }}">Crear</a>
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="{{ route('manager.users') }}">Listado</a>
                <span class="icon-thumbnail">gm</span>
              </li>
              <li class="">
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="{{ route('manager.customers') }}">Listado</a>
                <span class="icon-thumbnail">gm</span>
              </li>
              <li class="">
          ...
          <li>
            ...
            <ul class="sub-menu">
              <li class="">
                <a href="{{ route('manager.commercials') }}">Listado</a>
                <span class="icon-thumbnail">gm</span>
              </li>
              <li class="">
          ...
          <li>
            ...
            <ul class="sub-menu">
              ...
              <li class="">
                <a href="{{ route('manager.notifications') }}">Notificaciones</a>
                <span class="icon-thumbnail">l</span>
              </li>
              <li class="">
                <a href="{{ route('manager.alerts') }}">Alertas</a>
