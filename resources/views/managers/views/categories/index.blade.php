                            ...
                            <div class="row col-lg-6 col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item "><a href="{{ route('manager.categories') }}">Categorias</a></li>
                                    </ol>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="justify-content-add">
                                    <a href="{{ route('manager.categories.create') }}" id="btn-add-contact" class="btn btn-primary rounded text-white content-btn-add">+</a>
                                </div>
                            </div>
                </div>
            <div class="row">
                                    ...
                                    <tbody id="customers">
                                        @foreach($categories as $categorie)
                                            <tr class="btn-reveal-trigger">
                                                    ...
                                                    <a href="#">
                                                        <div class="media d-flex align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mb-0 fs--1">{{ $categorie->label }}</h5>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </td>
                                                ...
                                                <td class="py-2">{{ humanize_date($categorie->created_at) }}</td>
                                                <td class="py-2 text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right border py-0">
                                                            ...
                                                            <a class="dropdown-item h-modal-delete" data-modal="delete-modal" data-href="/manager/categories/destroy/" data-slack="{{ $categorie->slack }}" >
                                                                Eliminar
                                                            </a>
                                                        </div>
                                                    </div>
