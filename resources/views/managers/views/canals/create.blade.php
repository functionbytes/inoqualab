            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['manager.canals.store'], 'method' => 'POST', 'id' => 'formCanals' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="agent" class="form-control" placeholder="Parsley" value=""  required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-2">
                                            
                                            <div class="form-group">
                                                <label class="text-label">Canal <span class="required">*</span></label>
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email" class="form-control" placeholder="Parsley" value=""  required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                <label class="text-label">Celular <span class="required">*</span></label>
                                                <input type="text" name="cellphone" class="form-control" placeholder="Parsley" value=""  required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                <label class="text-label">Telefono <span class="required">*</span></label>
                                                <input type="text" name="phone" class="form-control" placeholder="Parsley" value=""  required>
                                            </div>
                                        </div> 
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                <label class="text-label">Extension <span class="required">*</span></label>
                                                <input type="text" name="ext" class="form-control" placeholder="Parsley" value=""  required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
