                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-12 p-md-0 justify-description-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('manager.publications') }}">Sedes</a></li>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        ...
                        {!! Form::open(['route' => ['manager.publications.update' , $publication->slack], 'method' => 'POST', 'id' => 'formPublications' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                        
                                {{ csrf_field() }}


                                <textarea style="display: none"  id="text-descriptions" name="description">{!! $publication->description !!}</textarea>
                                <input type="hidden" id="id" name="id" value="{{ $publication->id }}">
                                <input type="hidden" id="slack" name="slack" value="{{ $publication->slack }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sublabel" class="form-control" placeholder="Parsley" value="{{ $publication->sublabel }}"  required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                                <div class="form-group">
                                                    <label class="text-label">Nombre <span class="required">*</span></label>
                                                    <input type="text" name="label" class="form-control" placeholder="Parsley" value="{{ $publication->label }}"  required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <div class="align-items-center">
                                                        {!! Form::select('section', $sections, $publication->section_id , ['class' => 'full-width select','type' => 'text' ,'name' => 'section' ,'id' => 'inlineFormCustomSelect' , 'data-init-plugin' => 'select2']) !!}
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="align-items-center">
                                                            {!! Form::select('available', $availables, $publication->available , ['class' => 'full-width select','type' => 'text' ,'name' => 'available' ,'id' => 'inlineFormCustomSelect' , 'data-init-plugin' => 'select2']) !!}
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
        ...
        description.on('text-change', function(delta, oldDelta, source) {
            ...
            var myThumbnail = new Dropzone("div#dropzoneThumbnail", {
                paramName: "file"
                , url: "{{ url('/manager/publications/file') }}"
                , addRemoveLinks: true
                ...
                init: function() {
                    ...
                    $.getJSON('/manager/publications/get/file/' + item, function(data) {
                    ...
                    myThumbnail.on('sending', function(file, xhr, formData) {
                        let publication = document.getElementById('slack').value;
                    ...
                    myThumbnail.on("removedfile", function(file) {
                        ...
                        if (item.length > 20) {
                            $.ajax({
                                type: 'GET'
                                , url: '/manager/publications/delete/file/' + item
