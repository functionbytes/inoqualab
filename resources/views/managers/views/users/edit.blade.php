            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['manager.users.update', $user->id], 'id' =>'step-form-horizontal' , 'class' =>'step-form-horizontal' , 'method' =>'POST', 'files' => true]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="password" class="form-control" id="inputGroupPrepend2" autocomplete="new-password" placeholder="*****">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <div class="align-items-center">
                                                        {!! Form::select('dependencie', $dependencies, $dependencie , ['class' => 'full-width select','type' => 'text' ,'name' => 'dependencie' ,'id' => 'inlineFormCustomSelect' , 'data-init-plugin' => 'select2']) !!}
