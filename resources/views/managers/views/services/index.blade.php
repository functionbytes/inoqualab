                            ...
                            <div class="row col-lg-6 col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item "><a href="{{ route('manager.services') }}">Servicios</a></li>
                                    </ol>
                                </div>
                            </div>
                                    ...
                                    <tbody id="customers">
                                        @foreach($services as $service)
                                            <tr class="btn-reveal-trigger">
                                                    ...
                                                    <a href="#">
                                                        <div class="media d-flex align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mb-0 fs--1">{{ $service->label }}</h5>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </td>
                                                ...
                                                <td class="py-2">{{ humanize_date($service->created_at) }}</td>
                                                <td class="py-2 text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right border py-0">
                                                            <a class="dropdown-item" href="{{ route('manager.services.edit', $service->slack) }}" >Editar</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
