                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-12 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('manager.schemes') }}">Escenas</a></li>
            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['manager.schemes.store'], 'method' => 'POST', 'id' => 'formSchemes' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <div class="align-items-center">
                                                    {!! Form::select('system', $systems, null , ['class' => 'full-width select','type' => 'text' ,'name' => 'system' ,'id' => 'inlineFormCustomSelect' , 'data-init-plugin' => 'select2']) !!}
                                            </div>
                                        </div>
                                    </div>
