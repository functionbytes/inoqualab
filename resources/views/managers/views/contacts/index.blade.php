                            ...
                            <div class="row col-lg-6 col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item "><a href="{{ route('manager.applications') }}">Cotizaciones</a></li>
                                    </ol>
                                </div>
                            </div>
                                    ...
                                    <tbody id="customers">
                                        @foreach($contacts as $contact)
                                            <tr class="btn-reveal-trigger">
                                                    ...
                                                    <a href="#">
                                                        <div class="media d-flex align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mb-0 fs--1">{{ $contact->names }}</h5>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </td>
                                                ...
                                                <td class="py-2">{{ humanize_date($contact->created_at) }}</td>
                                                <td class="py-2 text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right border py-0">
                                                            ...
                                                            <a class="dropdown-item h-modal-delete" data-modal="delete-modal" data-href="/manager/contacts/destroy/" data-slack="{{ $contact->slack }}" >
                                                                Eliminar
                                                            </a>
                                                        </div>
                                                    </div>
