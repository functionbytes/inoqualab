        ...
        <div class="form-head d-flex mb-3 align-items-start">
            <div class="mr-auto d-lg-block">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item "><a href="{{ route('manager.petitions') }}">Peticiones</a></li>
                        ...
                        <div class="card h-auto">
                            ...
                            <ul class="list-group list-group-flush">
								<li class="list-group-item d-flex justify-content-between">
                                    <span class="mb-0">Email : {{ $petition->email }}</span>
								<li class="list-group-item d-flex justify-content-between">
                                    <span class="mb-0">Celular : {{ $petition->cellphone }}</span>
                                </li>

                                <li class="list-group-item d-flex justify-content-between">
                                    <span class="mb-0">Tipo : {{ $petition->type->title }}</span>
                                </li>

                                <li class="list-group-item d-flex justify-content-between">
                                    <span class="mb-0">Dependencia : {{ $petition->dependencie->title }}</span>
                                </li>
                            </ul>
                                            ...
                                            @foreach($reports as $report)
                                                <li>
                                                    ...
                                                    <a class="timeline-panel text-muted" href="javascript:void(0);">
                                                        <h4 class="mb-2"> Petición  {{ $report->status->label }}</h4>
            ...
            <div class="col-lg-12 col-xl-9 col-md-12">
                <div class="card">
                    <div class="card-header border-0 d-sm-flex d-block pb-0">
                        ...
                        <a href="{{ route('manager.petitions.tracing', $petition->slack) }}" class="btn btn-primary shadow-primary btn-rounded text-white"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">+ Mensaje nuevo</font></font></a>
                    </div>
                    <div class="card-body">
