        ...
        <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-12 p-md-0 justify-description-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('manager.faqs') }}">Pregutnas</a></li>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12">
                    ...
                    {!! Form::open(['route' => ['manager.faqs.update' , $faq->slack], 'method' => 'POST', 'id' => 'formFaqs' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="label" class="form-control" placeholder="Parsley" value="{{ $faq->label }}"  required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                                <div class="form-group">
                                                    <label class="text-label">Posicion <span class="required">*</span></label>
                                                    <input type="text" name="position" class="form-control" placeholder="0" value="{{ $faq->position }}"  required>
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="align-items-center">
                                                            {!! Form::select('available', $availables, $faq->available , ['class' => 'full-width select','type' => 'text' ,'name' => 'available' ,'id' => 'inlineFormCustomSelect' , 'data-init-plugin' => 'select2']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 mb-2">
