                                    ...
                                    <tbody id="customers">
                                        @foreach($faqs as $faq)
                                            <tr class="btn-reveal-trigger">
                                                    ...
                                                    <a href="#">
                                                        <div class="media d-flex align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <h5 class="mb-0 fs--1">{{substr(strip_tags($faq->label), 0, 100)}}...</h5>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </td>
                                                ...
                                                <td class="py-2">{{ humanize_date($faq->created_at) }}</td>
                                                <td class="py-2 text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right border py-0">
                                                            ...
                                                            <a class="dropdown-item h-modal-delete" data-modal="delete-modal" data-href="/manager/faqs/destroy/" data-slack="{{ $faq->slack }}" >
                                                                Eliminar
                                                            </a>
                                                        </div>
                                                    </div>
