                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-12 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('manager.dependencies') }}">Dependencias</a></li>
            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['manager.dependencies.store'], 'id' =>'step-form-horizontal' , 'class' =>'step-form-horizontal' , 'method' =>'POST', 'files' => true]) !!}
