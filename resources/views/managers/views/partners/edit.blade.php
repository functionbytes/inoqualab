            ...
            <div class="col-lg-12">
                ...
                <div class="col-sm-12 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('manager.partners') }}">Aliados</a></li>
            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['manager.partners.update' , $partner->slack], 'method' => 'POST', 'id' => 'formPartners' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="label" class="form-control" placeholder="Parsley" value="{{ $partner->label }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <div class="align-items-center">
                                                    {!! Form::select('available', $availables, $partner->available , ['class' => 'full-width select','type' => 'text' ,'name' => 'available' ,'id' => 'inlineFormCustomSelect' , 'data-init-plugin' => 'select2']) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="url" class="form-control" placeholder="Parsley" value="{{ $partner->url }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" col="4" class="form-control" placeholder="Parsley" required> {{ $partner->description }}</textarea>
                                            </div>
                                        </div>
    ...
    $(document).ready(function() {
        ...
        var myPdf = new Dropzone("div#dropzonePdf", {
            ...
            init: function() {
                ...
                $.getJSON('/manager/partners/get/pdf/' + item, function(data) {
                    $.each(data, function(key, value) {
                        var mockFile = {
                            name: value.file
                            , size: value.size
                ...
                myPdf.on("removedfile", function(file) {
                    ...
                    if (item.length > 20) {
                        $.ajax({
                            type: 'GET'
                            , url: '/manager/partners/delete/pdf/' + item
                            , success: function(result) {
                                //$('#dropzoneThumbnail').addClass('dz-started');
                            }
                        });
