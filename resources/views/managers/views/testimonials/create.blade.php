            ...
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['manager.testimonials.store'], 'method' => 'POST', 'id' => 'formFaqs' , 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="charger" class="form-control" placeholder="Parsley" value=""  required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
