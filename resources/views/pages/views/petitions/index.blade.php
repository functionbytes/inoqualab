            ...
            <div class="col-md-4 mb-6 mb-lg-0">
                <div class="card shadow-2 px-7 pb-6 pt-4 h-100 border-0">
                    ...
                    <div class="card-body px-0 pt-6 text-center pb-0">
                        <p class="card-text px-2">
							INOQUALAB dará respuesta dentro de los diez (10) días hábiles siguientes de recibido la notificación, a través de correo electrónico informando sobre el avance o cierre del mismo.
                        </p>
                    </div>
                </div>
            </div>
