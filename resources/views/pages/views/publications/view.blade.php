                    ...
                    <div class="featured-imagebox featured-imagebox-post ttm-box-view-top-image">
                        <div class="ttm-post-featured-outer">
                            ...
                            <div class="ttm-box-post-date">
                                <span class="ttm-entry-date">
                                    <time class="entry-date" datetime="2019-01-16T07:07:55+00:00"><span class="entry-month"><span class="entry-year">{{ $publication->sublabel }}</span></span></time>
                                </span>
                            </div>
                        </div>
                        <div class="featured-content featured-content-post box-shadow">
                            ...
                            <div class="post-desc featured-desc">
                                ...
                                <a class="ttm-btn ttm-btn-size-sm ttm-icon-btn-right ttm-btn-color-skincolor btn-inline" target="_blank" href="{{ asset('/pages/images/publications/'.$publication->file()->filename) }}">DERCARGAR<i class="fa fa-arrow-right"></i></a>
                                @endif
                            </div>
                        </div>
                    </div>
