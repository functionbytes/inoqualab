<section id="projects-1" class="pt-100 projects-section">
    <div class="container">
                    ...
                    <div id="pt-1-1" class="project-details">
                        ...
                        <div class="project-preview r-10">
                            ...
                            <div class="project-link ico-35 color--white">
                                <a href="project-details.html" title=""><span class="flaticon-visibility"></span></a>
                            </div>
        ...
        <div class="row">
            <div class="col">
                <div class="more-projects wow fadeInUp" style="visibility: hidden; animation-name: none;">
                    <a href="projects.html" class="btn btn--theme hover--tra-black">See more projects</a>
                </div>
            </div>
        </div>
