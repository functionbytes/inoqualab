    ...
    <div class="container">
        ...
        <div class="integrations-2-wrapper bg--white-400 r-12 text-center">
            ...
            <div class="row row-cols-1 row-cols-sm-3 row-cols-md-5">
                ...
                <!-- TOOL #1 -->
                <div class="col">
                    <a href="#" class="in_tool it-1 r-12 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                ...
                <!-- TOOL #2 -->
                <div class="col">
                    <a href="#" class="in_tool it-2 r-12 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                ...
                <!-- TOOL #3 -->
                <div class="col">
                    <a href="#" class="in_tool it-3 r-12 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                ...
                <!-- TOOL #4 -->
                <div class="col">
                    <a href="#" class="in_tool it-4 r-12 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                ...
                <!-- TOOL #5 -->
                <div class="col">
                    <a href="#" class="in_tool it-5 r-12 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
