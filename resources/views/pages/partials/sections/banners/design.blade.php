        ...
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9 col-xl-10">
                    <div class="hero-12-txt color--white wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
            ...
            <div class="row">
                <div class="col">
                    <div class="hero-12-img video-preview wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
