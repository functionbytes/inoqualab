<section id="hero-26" class="bg--scroll hero-section">
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <!-- HERO TEXT -->
            <div class="col-md-6">
                <div class="hero-26-txt color--white wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">

                    <!-- Title -->
                    <h2 class="s-60 w-700">Add creativity to your project</h2>

                    <!-- Text -->
                    <p class="p-lg">Mauris donec turpis suscipit diam sapien ociis sagittis sapien tempor
            ...
            <!-- HERO IMAGE -->
            <div class="col-md-6">
                <div class="hero-26-img wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
