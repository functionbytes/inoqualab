    ...
    <div class="hero-overlay">
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <!-- HERO TEXT -->
                <div class="col-md-6">
                    <div class="hero-7-txt wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                ...
                <!-- HERO IMAGE -->
                <div class="col-md-6">
                    <div class="hero-7-img text-center wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
