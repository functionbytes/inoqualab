    ...
    <div class="container text-center">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-9">
                <div class="hero-14-txt color--white wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">

                    <!-- Title -->
                    <h2 class="s-60 w-700">Automate your way to success with Martex</h2>

                    <!-- Text -->
                    <p class="s-21">Mauris donec ociis diam magnis sapien sagittis sapien tempor volute gravida
        ...
        <div class="row">
            <div class="col">
                <div class="hero-14-img wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                    <img class="img-fluid" src="images/dashboard-02.png" alt="hero-image">
                </div>
            </div>
        </div>	<!-- END HERO IMAGE -->
