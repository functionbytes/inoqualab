        ...
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="hero-27-txt wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">

                        <!-- Title -->
                        <h2 class="s-60 w-700">The complete toolkit to engage your business</h2>

                        <!-- Text -->
                        <p class="s-20">Mauris donec ociis diam magnis sapien sagittis sapien tempor volute
                        ...
                        <div class="btns-group">
                            ...
                            <a href="https://www.youtube.com/watch?v=7e90gBu4pas" class="video-popup2 btn r-04 btn--tra-black hover--theme ico-20 ico-right">
