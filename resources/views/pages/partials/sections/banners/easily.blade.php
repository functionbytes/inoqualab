    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6 order-last order-md-2">
                <div class="hero-18-img wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                    <img class="img-fluid" src="images/hero-18-img.png" alt="hero-image">
                </div>
            </div>
            ...
            <div class="col-md-6 order-first order-md-2">
                <div class="hero-18-txt wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
