    ...
    <div class="container text-center">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-9">
                <div class="hero-21-txt wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
        ...
        <div class="hero-21-wrapper r-34">
            <div class="hero-overlay bg--fixed">
                <div class="row">
                    <div class="col">
                        <div class="hero-21-img video-preview wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            ...
                            <!-- Preview Image -->
                            <img class="img-fluid" src="images/tablet-01.png" alt="video-preview">
