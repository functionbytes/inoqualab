    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6 col-lg-7">
                <div class="hero-8-txt color--white wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
            ...
            <div class="col-md-6 col-lg-5">
                <div id="hero-8-form" class="r-10 wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
