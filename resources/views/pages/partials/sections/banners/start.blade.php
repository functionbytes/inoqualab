    ...
    <div class="container">
        <div class="hero-6-wrapper r-16">
            <div class="row d-flex align-items-center">
                ...
                <!-- HERO TEXT -->
                <div class="col-md-6">
                    <div class="hero-6-txt wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">

                        <!-- Title -->
                        <h2 class="s-54 w-700">Start with a plan and finish with results</h2>

                        <!-- Text -->
                        <p class="p-lg">Sodales tempor sapien quaerat ipsum congue and laoreet turpis neque
                ...
                <!-- HERO IMAGE -->
                <div class="col-md-6">
                    <div class="hero-6-img wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
